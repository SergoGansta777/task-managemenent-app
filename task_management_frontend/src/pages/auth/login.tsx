  ...
  return (
    <div className="flex w-full h-screen">
      <div
        ...
        relative"
      >
        <div className="w-60 h-60 bg-gradient-to-tr from-accent to-accent-foreground rounded-full animate-spin-slow" />
        <div className="w-full h-1/2 bg-accent-foreground/4 backdrop-blur-lg absolute bottom-0" />
      </div>
