...
export function BoardColumn({
  ...
  const variants = cva(
    "h-auto text-sm max-h-[550px] bg-primary-foreground flex flex-col flex-shrink-0 snap-center group",
    {
      variants: {
        dragging: {
  ...
  return (
    <div className="flex flex-col">
      ...
      >
        <CardHeader className="px-4 py-2 font-semibold border-b-2 text-left flex flex-row justify-between gap-3 items-center">
